...
//*******************************************************
//                    Question
// n*m grid of char is given and a string of word is given
//we have to find that word 
//condition is the next charter of the finding string must 
//exist on adjacant non - dignoanal on the grid
//*******************************************************
